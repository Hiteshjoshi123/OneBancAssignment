...
fetch("https://dev.onebanc.ai/assignment.asmx/GetTransactionHistory?userId=1&recipientId=2", {
    ...
    .then((data) => {
        ...
        document.getElementById("time1").innerHTML = res + ',' + time + ' ' + 'PM';

        var time = n1.slice(11, 16);
        document.getElementById("time2").innerHTML = res1 + ',' + time + ' ' + 'PM';

        var time = n2.slice(11, 16);
        document.getElementById("time3").innerHTML = res2 + ',' + time + ' ' + 'PM';

        var time = n3.slice(11, 16);
        document.getElementById("time4").innerHTML = res3 + ',' + time + ' ' + 'PM';
